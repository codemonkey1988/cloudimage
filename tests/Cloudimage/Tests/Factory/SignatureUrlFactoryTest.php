...
use Codemonkey1988\Cloudimage\Factory\SignatureUriFactory;
...
final class SignatureUrlFactoryTest extends TestCase
{
    ...
    {
        $operation = new Cdn();
        $subject = new SignatureUriFactory($operation, $this->token, $this->salt);
